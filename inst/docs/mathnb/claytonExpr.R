...
structure(expression((u1^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * 
    (u1^((-alpha) - 1) * (-alpha))), (-1 + u1^(-alpha) + u2^(-alpha))^((-1/alpha) - 
    ...
    1) * ((-1/alpha) * (u1^((-alpha) - 1) * (-alpha))), (u1^(-alpha))^((-1/alpha) - 
    1) * ((-1/alpha) * (u1^((-alpha) - 1) * (-alpha))), (-1 + 
    u1^(-alpha) + u2^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * 
    (u1^((-alpha) - 1) * (-alpha))), (-2 + u1^(-alpha) + u2^(-alpha) + 
    u3^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * (u1^((-alpha) - 
    1) * (-alpha))), (-3 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
    u4^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * (u1^((-alpha) - 
    1) * (-alpha))), (-4 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
    u4^(-alpha) + u5^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * 
    (u1^((-alpha) - 1) * (-alpha))), (-5 + u1^(-alpha) + u2^(-alpha) + 
    u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + u6^(-alpha))^((-1/alpha) - 
    1) * ((-1/alpha) * (u1^((-alpha) - 1) * (-alpha))), (-6 + 
    u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + 
    u6^(-alpha) + u7^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * 
    (u1^((-alpha) - 1) * (-alpha))), (-7 + u1^(-alpha) + u2^(-alpha) + 
    u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + u6^(-alpha) + u7^(-alpha) + 
    u8^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * (u1^((-alpha) - 
    1) * (-alpha))), (-8 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
    u4^(-alpha) + u5^(-alpha) + u6^(-alpha) + u7^(-alpha) + u8^(-alpha) + 
    u9^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * (u1^((-alpha) - 
    1) * (-alpha))), (-9 + u1^(-alpha) + u10^(-alpha) + u2^(-alpha) + 
    u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + u6^(-alpha) + u7^(-alpha) + 
    u8^(-alpha) + u9^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * 
    (u1^((-alpha) - 1) * (-alpha))), (u1^(-alpha))^((-1/alpha) - 
    1) * ((-1/alpha) * (u1^((-alpha) - 1) * (-alpha))), (-1 + 
    u1^(-alpha) + u2^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * 
    (u1^((-alpha) - 1) * (-alpha))), (-2 + u1^(-alpha) + u2^(-alpha) + 
    u3^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * (u1^((-alpha) - 
...
structure(expression((u1^(-alpha))^(-1/alpha) * (log((u1^(-alpha))) * 
    (1/alpha^2)) - (u1^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * 
    (u1^(-alpha) * log(u1))), (-1 + u1^(-alpha) + u2^(-alpha))^(-1/alpha) * 
    ...
    ((-1/alpha) * (u9^(-alpha) * log(u9) + (u8^(-alpha) * log(u8) + 
        (u7^(-alpha) * log(u7) + (u6^(-alpha) * log(u6) + (u5^(-alpha) * 
            ...
            log(u10) + u1^(-alpha) * log(u1))))))))))), (u1^(-alpha))^(-1/alpha) * 
    (log((u1^(-alpha))) * (1/alpha^2)) - (u1^(-alpha))^((-1/alpha) - 
    1) * ((-1/alpha) * (u1^(-alpha) * log(u1))), (-1 + u1^(-alpha) + 
    u2^(-alpha))^(-1/alpha) * (log((-1 + u1^(-alpha) + u2^(-alpha))) * 
    (1/alpha^2)) - (-1 + u1^(-alpha) + u2^(-alpha))^((-1/alpha) - 
    1) * ((-1/alpha) * (u2^(-alpha) * log(u2) + u1^(-alpha) * 
    log(u1))), (-2 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha))^(-1/alpha) * 
    (log((-2 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha))) * (1/alpha^2)) - 
    (-2 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha))^((-1/alpha) - 
        1) * ((-1/alpha) * (u3^(-alpha) * log(u3) + (u2^(-alpha) * 
        log(u2) + u1^(-alpha) * log(u1)))), (-3 + u1^(-alpha) + 
    u2^(-alpha) + u3^(-alpha) + u4^(-alpha))^(-1/alpha) * (log((-3 + 
    u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha))) * 
    (1/alpha^2)) - (-3 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
    u4^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * (u4^(-alpha) * 
    log(u4) + (u3^(-alpha) * log(u3) + (u2^(-alpha) * log(u2) + 
    u1^(-alpha) * log(u1))))), (-4 + u1^(-alpha) + u2^(-alpha) + 
    u3^(-alpha) + u4^(-alpha) + u5^(-alpha))^(-1/alpha) * (log((-4 + 
    u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + u5^(-alpha))) * 
    (1/alpha^2)) - (-4 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
    u4^(-alpha) + u5^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * 
    (u5^(-alpha) * log(u5) + (u4^(-alpha) * log(u4) + (u3^(-alpha) * 
        log(u3) + (u2^(-alpha) * log(u2) + u1^(-alpha) * log(u1)))))), 
    (-5 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + 
        u5^(-alpha) + u6^(-alpha))^(-1/alpha) * (log((-5 + u1^(-alpha) + 
        u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + 
        u6^(-alpha))) * (1/alpha^2)) - (-5 + u1^(-alpha) + u2^(-alpha) + 
        u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + u6^(-alpha))^((-1/alpha) - 
        1) * ((-1/alpha) * (u6^(-alpha) * log(u6) + (u5^(-alpha) * 
        log(u5) + (u4^(-alpha) * log(u4) + (u3^(-alpha) * log(u3) + 
        (u2^(-alpha) * log(u2) + u1^(-alpha) * log(u1))))))), 
    (-6 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + 
        u5^(-alpha) + u6^(-alpha) + u7^(-alpha))^(-1/alpha) * 
        (log((-6 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
            u4^(-alpha) + u5^(-alpha) + u6^(-alpha) + u7^(-alpha))) * 
            (1/alpha^2)) - (-6 + u1^(-alpha) + u2^(-alpha) + 
        u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + u6^(-alpha) + 
        u7^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * (u7^(-alpha) * 
        log(u7) + (u6^(-alpha) * log(u6) + (u5^(-alpha) * log(u5) + 
        (u4^(-alpha) * log(u4) + (u3^(-alpha) * log(u3) + (u2^(-alpha) * 
            log(u2) + u1^(-alpha) * log(u1)))))))), (-7 + u1^(-alpha) + 
        u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + 
        u6^(-alpha) + u7^(-alpha) + u8^(-alpha))^(-1/alpha) * 
        (log((-7 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
            u4^(-alpha) + u5^(-alpha) + u6^(-alpha) + u7^(-alpha) + 
            u8^(-alpha))) * (1/alpha^2)) - (-7 + u1^(-alpha) + 
        u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + 
        u6^(-alpha) + u7^(-alpha) + u8^(-alpha))^((-1/alpha) - 
        1) * ((-1/alpha) * (u8^(-alpha) * log(u8) + (u7^(-alpha) * 
        log(u7) + (u6^(-alpha) * log(u6) + (u5^(-alpha) * log(u5) + 
        ...
        u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + 
        u6^(-alpha) + u7^(-alpha) + u8^(-alpha) + u9^(-alpha))^(-1/alpha) * 
        (log((-8 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
            u4^(-alpha) + u5^(-alpha) + u6^(-alpha) + u7^(-alpha) + 
            u8^(-alpha) + u9^(-alpha))) * (1/alpha^2)) - (-8 + 
        u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + 
        u5^(-alpha) + u6^(-alpha) + u7^(-alpha) + u8^(-alpha) + 
        u9^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * (u9^(-alpha) * 
        log(u9) + (u8^(-alpha) * log(u8) + (u7^(-alpha) * log(u7) + 
        (u6^(-alpha) * log(u6) + (u5^(-alpha) * log(u5) + (u4^(-alpha) * 
            ...
            log(u2) + u1^(-alpha) * log(u1)))))))))), (-9 + u1^(-alpha) + 
        u10^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + 
        u5^(-alpha) + u6^(-alpha) + u7^(-alpha) + u8^(-alpha) + 
        u9^(-alpha))^(-1/alpha) * (log((-9 + u1^(-alpha) + u10^(-alpha) + 
        u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + 
        u6^(-alpha) + u7^(-alpha) + u8^(-alpha) + u9^(-alpha))) * 
        (1/alpha^2)) - (-9 + u1^(-alpha) + u10^(-alpha) + u2^(-alpha) + 
        u3^(-alpha) + u4^(-alpha) + u5^(-alpha) + u6^(-alpha) + 
        u7^(-alpha) + u8^(-alpha) + u9^(-alpha))^((-1/alpha) - 
        1) * ((-1/alpha) * (u9^(-alpha) * log(u9) + (u8^(-alpha) * 
        log(u8) + (u7^(-alpha) * log(u7) + (u6^(-alpha) * log(u6) + 
        (u5^(-alpha) * log(u5) + (u4^(-alpha) * log(u4) + (u3^(-alpha) * 
            log(u3) + (u2^(-alpha) * log(u2) + (u10^(-alpha) * 
            log(u10) + u1^(-alpha) * log(u1))))))))))), (u1^(-alpha))^(-1/alpha) * 
        (log((u1^(-alpha))) * (1/alpha^2)) - (u1^(-alpha))^((-1/alpha) - 
        ...
        1) * ((-1/alpha) * (u2^(-alpha) * log(u2) + u1^(-alpha) * 
        log(u1))), (-2 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha))^(-1/alpha) * 
        (log((-2 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha))) * 
            (1/alpha^2)) - (-2 + u1^(-alpha) + u2^(-alpha) + 
        u3^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * (u3^(-alpha) * 
        log(u3) + (u2^(-alpha) * log(u2) + u1^(-alpha) * log(u1)))), 
    (-3 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha))^(-1/alpha) * 
        (log((-3 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
            u4^(-alpha))) * (1/alpha^2)) - (-3 + u1^(-alpha) + 
        u2^(-alpha) + u3^(-alpha) + u4^(-alpha))^((-1/alpha) - 
        1) * ((-1/alpha) * (u4^(-alpha) * log(u4) + (u3^(-alpha) * 
        log(u3) + (u2^(-alpha) * log(u2) + u1^(-alpha) * log(u1))))), 
    (-4 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + 
        u5^(-alpha))^(-1/alpha) * (log((-4 + u1^(-alpha) + u2^(-alpha) + 
        u3^(-alpha) + u4^(-alpha) + u5^(-alpha))) * (1/alpha^2)) - 
        (-4 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + 
            u5^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * (u5^(-alpha) * 
            log(u5) + (u4^(-alpha) * log(u4) + (u3^(-alpha) * 
            log(u3) + (u2^(-alpha) * log(u2) + u1^(-alpha) * 
            log(u1)))))), (-5 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
        u4^(-alpha) + u5^(-alpha) + u6^(-alpha))^(-1/alpha) * 
        (log((-5 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
            u4^(-alpha) + u5^(-alpha) + u6^(-alpha))) * (1/alpha^2)) - 
        (-5 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + 
            u5^(-alpha) + u6^(-alpha))^((-1/alpha) - 1) * ((-1/alpha) * 
            (u6^(-alpha) * log(u6) + (u5^(-alpha) * log(u5) + 
                (u4^(-alpha) * log(u4) + (u3^(-alpha) * log(u3) + 
                  (u2^(-alpha) * log(u2) + u1^(-alpha) * log(u1))))))), 
    (-6 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + u4^(-alpha) + 
        u5^(-alpha) + u6^(-alpha) + u7^(-alpha))^(-1/alpha) * 
        (log((-6 + u1^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
        ...
        (u5^(-alpha) * log(u5) + (u4^(-alpha) * log(u4) + (u3^(-alpha) * 
            log(u3) + (u2^(-alpha) * log(u2) + (u10^(-alpha) * 
            log(u10) + u1^(-alpha) * log(u1)))))))))))), .Dim = c(3L, 
10L))
...
structure(expression(u1 * ((u1^(-alpha))^(1/alpha) * (log((u1^(-alpha))) * 
    (1/alpha^2)) + (u1^(-alpha))^((1/alpha) - 1) * ((1/alpha) * 
    ...
    ((u1^(-1 - alpha) - (1 + alpha) * (u1^(-1 - alpha) * log(u1))) * 
        ...
        (-9 + u1^(-alpha) + u10^(-alpha) + u2^(-alpha) + u3^(-alpha) + 
            ...
            ((-10 - 1/alpha) * (u9^(-alpha) * log(u9) + (u8^(-alpha) * 
                ...
                log(u1)))))))))))), u1 * ((u1^(-alpha))^(1/alpha) * 
        (log((u1^(-alpha))) * (1/alpha^2)) + (u1^(-alpha))^((1/alpha) - 
        1) * ((1/alpha) * (u1^(-alpha) * log(u1))))/(u1 * (u1^(-alpha))^(1/alpha))^2, 
    ((u1^(-1 - alpha) - (1 + alpha) * (u1^(-1 - alpha) * log(u1))) * 
        u2^(-1 - alpha) - (1 + alpha) * u1^(-1 - alpha) * (u2^(-1 - 
        alpha) * log(u2))) * (-1 + u1^(-alpha) + u2^(-alpha))^(-2 - 
        1/alpha) + (1 + alpha) * u1^(-1 - alpha) * u2^(-1 - alpha) * 
