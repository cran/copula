...
structure(expression(E^(-(alpha * u1)) * (log(E) * alpha)/E^(-(alpha * 
    ...
    E^(-(alpha * u1)) * (log(E) * alpha)/E^(-(alpha * u1))/alpha, 
    E^(-(alpha * u1)) * (log(E) * alpha) * (-1 + E^(-(alpha * 
        u2)))/(-1 + E^(-alpha))/(1 + ((-1 + E^(-(alpha * u1))) * 
        (-1 + E^(-(alpha * u2))))/(-1 + E^(-alpha)))/alpha, E^(-(alpha * 
        u1)) * (log(E) * alpha) * (-1 + E^(-(alpha * u2))) * 
        (-1 + E^(-(alpha * u3)))/(-1 + E^(-alpha))^2/(1 + ((-1 + 
        E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * (-1 + 
        E^(-(alpha * u3))))/(-1 + E^(-alpha))^2)/alpha, E^(-(alpha * 
        u1)) * (log(E) * alpha) * (-1 + E^(-(alpha * u2))) * 
        (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4)))/(-1 + 
        E^(-alpha))^3/(1 + ((-1 + E^(-(alpha * u1))) * (-1 + 
        E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * (-1 + 
        E^(-(alpha * u4))))/(-1 + E^(-alpha))^3)/alpha, E^(-(alpha * 
        u1)) * (log(E) * alpha) * (-1 + E^(-(alpha * u2))) * 
        (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))) * 
        (-1 + E^(-(alpha * u5)))/(-1 + E^(-alpha))^4/(1 + ((-1 + 
        E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * (-1 + 
        E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))) * (-1 + 
        E^(-(alpha * u5))))/(-1 + E^(-alpha))^4)/alpha, E^(-(alpha * 
        u1)) * (log(E) * alpha) * (-1 + E^(-(alpha * u2))) * 
        (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))) * 
        (-1 + E^(-(alpha * u5))) * (-1 + E^(-(alpha * u6)))/(-1 + 
        E^(-alpha))^5/(1 + ((-1 + E^(-(alpha * u1))) * (-1 + 
        E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * (-1 + 
        E^(-(alpha * u4))) * (-1 + E^(-(alpha * u5))) * (-1 + 
        E^(-(alpha * u6))))/(-1 + E^(-alpha))^5)/alpha, E^(-(alpha * 
        u1)) * (log(E) * alpha)/E^(-(alpha * u1))/alpha, E^(-(alpha * 
        u1)) * (log(E) * alpha) * (-1 + E^(-(alpha * u2)))/(-1 + 
        E^(-alpha))/(1 + ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * 
        u2))))/(-1 + E^(-alpha)))/alpha, E^(-(alpha * u1)) * 
        (log(E) * alpha) * (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * 
        u3)))/(-1 + E^(-alpha))^2/(1 + ((-1 + E^(-(alpha * u1))) * 
        (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))))/(-1 + 
        E^(-alpha))^2)/alpha, E^(-(alpha * u1)) * (log(E) * alpha) * 
        (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * 
        (-1 + E^(-(alpha * u4)))/(-1 + E^(-alpha))^3/(1 + ((-1 + 
        E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * (-1 + 
        E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))))/(-1 + 
        E^(-alpha))^3)/alpha, E^(-(alpha * u1)) * (log(E) * alpha) * 
        (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * 
        (-1 + E^(-(alpha * u4))) * (-1 + E^(-(alpha * u5)))/(-1 + 
        E^(-alpha))^4/(1 + ((-1 + E^(-(alpha * u1))) * (-1 + 
        E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * (-1 + 
        E^(-(alpha * u4))) * (-1 + E^(-(alpha * u5))))/(-1 + 
        E^(-alpha))^4)/alpha, E^(-(alpha * u1)) * (log(E) * alpha) * 
        (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * 
        (-1 + E^(-(alpha * u4))) * (-1 + E^(-(alpha * u5))) * 
        (-1 + E^(-(alpha * u6)))/(-1 + E^(-alpha))^5/(1 + ((-1 + 
        E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * (-1 + 
        E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))) * (-1 + 
        E^(-(alpha * u5))) * (-1 + E^(-(alpha * u6))))/(-1 + 
        E^(-alpha))^5)/alpha), .Dim = c(3L, 6L))
...
structure(expression(E^(-(alpha * u1)) * (log(E) * u1)/E^(-(alpha * 
    u1))/alpha + log(E^(-(alpha * u1)))/alpha^2, (((-1 + E^(-(alpha * 
    u1))) * (E^(-(alpha * u2)) * (log(E) * u2)) + E^(-(alpha * 
    u1)) * (log(E) * u1) * (-1 + E^(-(alpha * u2))))/(-1 + E^(-alpha)) - 
    ...
    u6))))/(-1 + E^(-alpha))^5)/alpha^2, E^(-(alpha * u1)) * 
    (log(E) * u1)/E^(-(alpha * u1))/alpha + log(E^(-(alpha * 
    u1)))/alpha^2, (((-1 + E^(-(alpha * u1))) * (E^(-(alpha * 
    u2)) * (log(E) * u2)) + E^(-(alpha * u1)) * (log(E) * u1) * 
    (-1 + E^(-(alpha * u2))))/(-1 + E^(-alpha)) - ((-1 + E^(-(alpha * 
    u1))) * (-1 + E^(-(alpha * u2)))) * (E^(-alpha) * log(E))/(-1 + 
    E^(-alpha))^2)/(1 + ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * 
    u2))))/(-1 + E^(-alpha)))/alpha + log(1 + ((-1 + E^(-(alpha * 
    u1))) * (-1 + E^(-(alpha * u2))))/(-1 + E^(-alpha)))/alpha^2, 
    (((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * (E^(-(alpha * 
        u3)) * (log(E) * u3)) + ((-1 + E^(-(alpha * u1))) * (E^(-(alpha * 
        u2)) * (log(E) * u2)) + E^(-(alpha * u1)) * (log(E) * 
        u1) * (-1 + E^(-(alpha * u2)))) * (-1 + E^(-(alpha * 
        u3))))/(-1 + E^(-alpha))^2 - ((-1 + E^(-(alpha * u1))) * 
        (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3)))) * 
        (2 * (E^(-alpha) * log(E) * (-1 + E^(-alpha))))/((-1 + 
        E^(-alpha))^2)^2)/(1 + ((-1 + E^(-(alpha * u1))) * (-1 + 
        E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))))/(-1 + 
        E^(-alpha))^2)/alpha + log(1 + ((-1 + E^(-(alpha * u1))) * 
        (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))))/(-1 + 
        E^(-alpha))^2)/alpha^2, (((-1 + E^(-(alpha * u1))) * 
        (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * 
        (E^(-(alpha * u4)) * (log(E) * u4)) + ((-1 + E^(-(alpha * 
        u1))) * (-1 + E^(-(alpha * u2))) * (E^(-(alpha * u3)) * 
        (log(E) * u3)) + ((-1 + E^(-(alpha * u1))) * (E^(-(alpha * 
        u2)) * (log(E) * u2)) + E^(-(alpha * u1)) * (log(E) * 
        u1) * (-1 + E^(-(alpha * u2)))) * (-1 + E^(-(alpha * 
        u3)))) * (-1 + E^(-(alpha * u4))))/(-1 + E^(-alpha))^3 - 
        ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * 
            (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4)))) * 
            (3 * (E^(-alpha) * log(E) * (-1 + E^(-alpha))^2))/((-1 + 
            E^(-alpha))^3)^2)/(1 + ((-1 + E^(-(alpha * u1))) * 
        (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * 
        (-1 + E^(-(alpha * u4))))/(-1 + E^(-alpha))^3)/alpha + 
        log(1 + ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * 
            u2))) * (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * 
            u4))))/(-1 + E^(-alpha))^3)/alpha^2, (((-1 + E^(-(alpha * 
        u1))) * (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * 
        u3))) * (-1 + E^(-(alpha * u4))) * (E^(-(alpha * u5)) * 
        (log(E) * u5)) + ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * 
        ...
        E^(-(alpha * u1)) * (log(E) * u1) * (-1 + E^(-(alpha * 
            u2)))) * (-1 + E^(-(alpha * u3)))) * (-1 + E^(-(alpha * 
        u4)))) * (-1 + E^(-(alpha * u5))))/(-1 + E^(-alpha))^4 - 
        ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * 
            (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))) * 
            (-1 + E^(-(alpha * u5)))) * (4 * (E^(-alpha) * log(E) * 
            (-1 + E^(-alpha))^3))/((-1 + E^(-alpha))^4)^2)/(1 + 
        ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * 
            (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))) * 
            (-1 + E^(-(alpha * u5))))/(-1 + E^(-alpha))^4)/alpha + 
        log(1 + ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * 
            u2))) * (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * 
            u4))) * (-1 + E^(-(alpha * u5))))/(-1 + E^(-alpha))^4)/alpha^2, 
    (((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * (-1 + 
        E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))) * (-1 + 
        E^(-(alpha * u5))) * (E^(-(alpha * u6)) * (log(E) * u6)) + 
        ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * 
            (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))) * 
            ...
            u3)) * (log(E) * u3)) + ((-1 + E^(-(alpha * u1))) * 
            (E^(-(alpha * u2)) * (log(E) * u2)) + E^(-(alpha * 
            u1)) * (log(E) * u1) * (-1 + E^(-(alpha * u2)))) * 
            (-1 + E^(-(alpha * u3)))) * (-1 + E^(-(alpha * u4)))) * 
            (-1 + E^(-(alpha * u5)))) * (-1 + E^(-(alpha * u6))))/(-1 + 
        E^(-alpha))^5 - ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * 
        u2))) * (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * 
        u4))) * (-1 + E^(-(alpha * u5))) * (-1 + E^(-(alpha * 
        u6)))) * (5 * (E^(-alpha) * log(E) * (-1 + E^(-alpha))^4))/((-1 + 
        E^(-alpha))^5)^2)/(1 + ((-1 + E^(-(alpha * u1))) * (-1 + 
        E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * (-1 + 
        E^(-(alpha * u4))) * (-1 + E^(-(alpha * u5))) * (-1 + 
        E^(-(alpha * u6))))/(-1 + E^(-alpha))^5)/alpha + log(1 + 
        ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * 
            (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))) * 
            (-1 + E^(-(alpha * u5))) * (-1 + E^(-(alpha * u6))))/(-1 + 
            E^(-alpha))^5)/alpha^2, E^(-(alpha * u1)) * (log(E) * 
        u1)/E^(-(alpha * u1))/alpha + log(E^(-(alpha * u1)))/alpha^2, 
    (((-1 + E^(-(alpha * u1))) * (E^(-(alpha * u2)) * (log(E) * 
        u2)) + E^(-(alpha * u1)) * (log(E) * u1) * (-1 + E^(-(alpha * 
        u2))))/(-1 + E^(-alpha)) - ((-1 + E^(-(alpha * u1))) * 
        (-1 + E^(-(alpha * u2)))) * (E^(-alpha) * log(E))/(-1 + 
        E^(-alpha))^2)/(1 + ((-1 + E^(-(alpha * u1))) * (-1 + 
        E^(-(alpha * u2))))/(-1 + E^(-alpha)))/alpha + log(1 + 
        ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))))/(-1 + 
            E^(-alpha)))/alpha^2, (((-1 + E^(-(alpha * u1))) * 
        (-1 + E^(-(alpha * u2))) * (E^(-(alpha * u3)) * (log(E) * 
        u3)) + ((-1 + E^(-(alpha * u1))) * (E^(-(alpha * u2)) * 
        (log(E) * u2)) + E^(-(alpha * u1)) * (log(E) * u1) * 
        (-1 + E^(-(alpha * u2)))) * (-1 + E^(-(alpha * u3))))/(-1 + 
        E^(-alpha))^2 - ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * 
        u2))) * (-1 + E^(-(alpha * u3)))) * (2 * (E^(-alpha) * 
        log(E) * (-1 + E^(-alpha))))/((-1 + E^(-alpha))^2)^2)/(1 + 
        ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * 
            (-1 + E^(-(alpha * u3))))/(-1 + E^(-alpha))^2)/alpha + 
        log(1 + ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * 
            u2))) * (-1 + E^(-(alpha * u3))))/(-1 + E^(-alpha))^2)/alpha^2, 
    (((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * (-1 + 
        E^(-(alpha * u3))) * (E^(-(alpha * u4)) * (log(E) * u4)) + 
        ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * 
            (E^(-(alpha * u3)) * (log(E) * u3)) + ((-1 + E^(-(alpha * 
            u1))) * (E^(-(alpha * u2)) * (log(E) * u2)) + E^(-(alpha * 
            u1)) * (log(E) * u1) * (-1 + E^(-(alpha * u2)))) * 
            (-1 + E^(-(alpha * u3)))) * (-1 + E^(-(alpha * u4))))/(-1 + 
        E^(-alpha))^3 - ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * 
        u2))) * (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * 
        u4)))) * (3 * (E^(-alpha) * log(E) * (-1 + E^(-alpha))^2))/((-1 + 
        E^(-alpha))^3)^2)/(1 + ((-1 + E^(-(alpha * u1))) * (-1 + 
        E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * (-1 + 
        E^(-(alpha * u4))))/(-1 + E^(-alpha))^3)/alpha + log(1 + 
        ((-1 + E^(-(alpha * u1))) * (-1 + E^(-(alpha * u2))) * 
            (-1 + E^(-(alpha * u3))) * (-1 + E^(-(alpha * u4))))/(-1 + 
            E^(-alpha))^3)/alpha^2, (((-1 + E^(-(alpha * u1))) * 
        (-1 + E^(-(alpha * u2))) * (-1 + E^(-(alpha * u3))) * 
        (-1 + E^(-(alpha * u4))) * (E^(-(alpha * u5)) * (log(E) * 
